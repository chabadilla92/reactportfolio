...
export default function AboutPage() {
    return (
        <div id="aboutpagebox" class="container-fluid">
            ...
            <div id="row3" class="row pt-4">
                <div id="col1" class="col-md-4">
                    <div class="row text-md-end"><h3>I am a  <i class="bi bi-arrow-right"></i></h3></div>
                </div>
                <div id="col2" class="col-md-6 offset-md-1">
            ...
            <div id="row4" class="row">
                <div id="col1" class="col-md-4">
                    <div class="row text-md-end"><h3>Skills <i class="bi bi-arrow-right"></i></h3></div>
                </div>
                <div id="col2" class="col-md-6 offset-md-1">
            ...
            <div id="row5" class="row">
                <div id="col1" class="col-md-4">
                    <div class="row text-md-end"><h3>Education <i class="bi bi-arrow-right"></i></h3></div>
                </div>
                <div id="col2" class="col-md-6 offset-md-1">
                    <div class="row">
            ...
            <div id="row6" class="row">
                <div id="col1" class="col-md-4">
                    <div class="row text-md-end"><h3>E-mail <i class="bi bi-arrow-right"></i></h3></div>
                </div>
                <div id="col2" class="col-md-6 offset-md-1 pb-4">
